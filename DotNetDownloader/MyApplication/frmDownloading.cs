...
namespace MyApplication
{
    ...
    {//coded by =alimousavi    instagram= 1_alimousavi_1  telegram=alimousavi_1
        ...
        {//coded by =alimousavi    instagram= 1_alimousavi_1  telegram=alimousavi_1
            ...
            DownloadDetails downloadDetails = new DownloadDetails()//download details
            {
            ...
            //connecting to main form and updating
            ...
            using (FileStream fs = new FileStream(savePath, FileMode.Create))
            {
                while (Downloaded < lenght)
                {
                    ...
                    {//coded by =alimousavi    instagram= 1_alimousavi_1  telegram=alimousavi_1
                        ...
                        //speeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed  :||||
